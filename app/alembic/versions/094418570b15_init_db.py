...
Revision ID: 094418570b15
Revises: 
Create Date: 2024-09-05 23:46:37.870305
...
def upgrade() -> None:
    ...
    sa.Column('regex_tracking_number', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index(op.f('ix_addresses_country_id'), 'addresses', ['country_id'], unique=False)
    op.create_index(op.f('ix_addresses_postal_code'), 'addresses', ['postal_code'], unique=False)
    op.create_index(op.f('ix_addresses_state_id'), 'addresses', ['state_id'], unique=False)
    ...
    sa.Column('total_weight_unit', sa.Enum('GRAM', 'KG', 'LB', name='weightunit'), nullable=False),
    ...
    op.create_index(op.f('ix_shipments_address_id'), 'shipments', ['address_id'], unique=False)
    ...
    sa.Column('weight_unit', sa.Enum('GRAM', 'KG', 'LB', name='weightunit'), nullable=False),
    ...
    sa.Column('dimensions_unit', sa.Enum('MM', 'CM', 'IN', name='dimensionsunit'), nullable=False),
